...
track_ref=[29, 29, 13, 9, 6, 6, 16, 30, 39, 59]
cloud_ref=[73, 42, 37, 22, 4, 14, 34, 48, 29, 88]

r_track=[13, 9, 6, 6, 16, 30,29, 29]
r_cloud=[37, 22, 4, 14, 34, 48,73, 42]
...
fig.show()
fig.write_image("Norilsk_JCT.png")
